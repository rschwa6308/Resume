  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Created a system for testing automated network security analysis tools (such as APL's AVRA) on simulated networks repeatably. Network topology, OS types, and software distributions may be specified. The resulting network is automatically virtualized via Docker and GNS3, and the testing procedure is run autonomously.}
      \resumeItemListEnd
