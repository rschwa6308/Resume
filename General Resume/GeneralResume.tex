...
\section{Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed tooling to optimize the flight-plan of fixed-wing aircraft under a complex objective function involving the communication between an onboard device and an orbital satellite. Utilized SNOPT and OTIS to search the space of physically feasible solutions with the help of custom tooling written in both Fortran and Python for non-linear optimization. Helped with integration of the new tool into an existing desktop architecture for use in the field.}
